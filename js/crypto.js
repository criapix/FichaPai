...
// Recebe o blob ({v,iter,salt,iv,ct}) e a senha. Retorna os bytes decifrados
// (ArrayBuffer). Lança erro se a senha estiver incorreta (falha na tag GCM).
